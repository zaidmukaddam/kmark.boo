  ...
  return (
    <CardSpotlight className="w-full h-96">
      <div className="flex flex-col gap-1 items-center justify-center h-full">
        ...
        <p className="text-sm text-zinc-500">Need help? Let us now at <a href="mailto:hello@kmark.boo" className="underline hover:text-zinc-200 duration-200">hello@kmark.boo</a>.</p>
      </div>
    </CardSpotlight>
  )
}
